        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="about-us.html" className="hover:text-primary">About Us</a></li>
              <li><a href="ministries.html" className="hover:text-primary">Ministries</a></li>
              <li><a href="give.html" className="hover:text-primary">Give</a></li>
              <li><a href="services.html" className="hover:text-primary">Services</a></li>
            </ul>
          </div>
          <div>
